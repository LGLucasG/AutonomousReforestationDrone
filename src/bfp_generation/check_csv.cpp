...
void drawPoints(const std::vector<Point> &points)
{
    ...
    if (xBound < 100 or xBound > 4000 or yBound < 100 or yBound > 4000)
    {
        std::cout << "xBound or yBound not between 100px and 4000px, there is probably an error during path computation." << std::endl;
        std::cout << "Try to run the path computation again." << std::endl;
        return;
    }
